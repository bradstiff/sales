...
const PayrollScope = ({ proposal, onSubmit, onClose, classes }) => {
    ...
    return <PayrollScopeForm initialValues={initialValues} proposal={proposal} canEdit={canEdit} onSubmit={onSubmit} onClose={onClose} />;
}

let firstCountry = null;
const PayrollScopeForm = ({initialValues, proposal, canEdit, onSubmit, onClose}) => (
    <Paper>
        <Formik
                            ...
                            <TableBody>
                                {values.countries.map((country, index) => (
                                    <TableRow key={index}>
                                        ...
                                        <TableCell>
                                            <Input name={`countries.${index}.monthlyPayees`} value={country.monthlyPayees} onChange={handleChange} />
                                        </TableCell>
                                        <TableCell>
                                            <Input name={`countries.${index}.semiMonthlyPayees`} value={country.semiMonthlyPayees} onChange={handleChange} />
                                        </TableCell>
                                        <TableCell>
                                            <Input name={`countries.${index}.biWeeklyPayees`} value={country.biWeeklyPayees} onChange={handleChange} />
                                        </TableCell>
                                        <TableCell>
                                            <Input name={`countries.${index}.weeklyPayees`} value={country.weeklyPayees} onChange={handleChange} />
                                        </TableCell>
                                    </TableRow>
                                ))}
                            </TableBody>
