using Autofac;
using MediatR;
using Proposing.API.Application.Behaviors;
...
namespace Proposing.API.Infrastructure.AutofacModules
{
    public class MediatorModule : Autofac.Module
    {
        protected override void Load(ContainerBuilder builder)
        {
            ...
            builder
                .RegisterAssemblyTypes(typeof(CreateProposalCommand).GetTypeInfo().Assembly)
